package org.me.pvh_group_02_spring_mini_project.jwt;
...
public class JwtService {
    ...
    public static final String SECRET = "PK/kD5K+asd9J5K0smfC2hHj8wh7k7sZxsUTN4aYS0Q=";
    ...
    private SecretKey getSignKey() {
        byte[] keyBytes = Base64.getDecoder().decode(SECRET); // Jwt.io does not support Base64 decoder
    ...
    //7. check expired token (true = expired)
